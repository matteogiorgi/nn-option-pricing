...
The results show that the feed-forward neural network approximates the Black-Scholes pricing function with very high accuracy on the sampled parameter domain.
...
The final results indicate that the neural network performs slightly better than the Monte Carlo benchmark in terms of MAE and RMSE on the reported experiment, while Monte Carlo obtains a slightly lower MAPE on prices greater than 1.
