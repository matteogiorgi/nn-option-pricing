...
The same noisy-target experiment was also repeated with the reduced-scale SVR
baseline. Table~\ref{tab:noisy-svr-targets} reports aggregate metrics against
clean Black-Scholes prices.
...
SVR remains accurate under mild label noise, but the degradation is stronger at
the 5\% noise level.
Since the SVR benchmark is run on reduced datasets, this comparison is best
interpreted as an additional classical robustness reference rather than as a
direct replacement for the neural network experiment.
