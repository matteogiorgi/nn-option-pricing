...
In compact form, the supervised task is to learn the pricing map

\begin{equation}
    (S_0, K, T, r, \sigma) \longmapsto C_{BS}(S_0, K, T, r, \sigma),
\end{equation}

where $C_{BS}$ is computed by the analytical Black-Scholes formula.
