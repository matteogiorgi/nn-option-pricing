...
The generated pages cover the project overview, methodology, experiment pipeline, additional experiments,
reproducibility instructions, command reference, testing strategy, and generated API reference.
The main Sphinx source entry points are:
...
\begin{itemize}
    ...
    \item \href{https://github.com/matteogiorgi/nn-option-pricing/blob/main/docs/source/reproducibility.rst}{\path{reproducibility.rst}}: reproducibility commands and tracked artifacts.
    \item \href{https://github.com/matteogiorgi/nn-option-pricing/blob/main/docs/source/command_reference.rst}{\path{command_reference.rst}}: command-line script reference.
    ...
    \item \href{https://github.com/matteogiorgi/nn-option-pricing/blob/main/docs/source/api/index.rst}{\path{api/index.rst}}: generated API reference index for the Python package.
\end{itemize}

\section{Local Documentation Build}

The HTML pages can be built locally from the repository root after installing the project and Sphinx dependencies:
...
The build can be run either in standard mode or in strict mode, and the generated HTML entry point can be found locally at \path{docs/build/html/index.html}:
...
With GitHub Pages enabled for the repository, the site is available through the repository Pages URL.
